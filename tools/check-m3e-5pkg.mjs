// tools/check-m3e-5pkg.mjs — assert packages/elm-m3e/packages.json is the D-037
...
const p = JSON.parse(readFileSync(new URL("../packages/elm-m3e/packages.json", import.meta.url))).packages;
