...
// Calibrated against real usage under packages/elm-m3e/docs/app/Route/Components/
// and packages/elm-m3e/src: `import M3e exposing (...)`, `import M3e.Attributes`,
...
const NUDGE_TEXT =
  ...
  "invoke the `m3e` skill before continuing. It is backed by packages/m3e-okf " +
  "(component API ground truth: skills/m3e/components/<name>.md; type roles: " +
  "knowledge/styles/typography.md; anti-patterns: knowledge/anti-patterns/). " +
