...
// packages/elm-m3e/review/src/NoProprietaryDsClasses.elm.
//
...
// (packages/tailwind-m3e-web/generated/utilities.json). Only the tiny, stable
...
const UTILITIES_MANIFEST = path.join(
  repoRoot,
  "packages/tailwind-m3e-web/generated/utilities.json",
);
...
const REVIEW_CONFIG = path.join(
  repoRoot,
  "packages/elm-m3e/review/src/ReviewConfig.elm",
);
...
const ALL_DIRS = [
  "packages/elm-m3e/docs/app",
  "packages/elm-m3e/docs/src",
  "packages/elm-m3e/src",
  "packages/elm-cem-compose/src",
];
...
function explain(violations) {
  ...
  return [
    ...
    "  - Type roles:  packages/m3e-okf/knowledge/styles/typography.md",
    "  - Component API ground truth: packages/m3e-okf/skills/m3e/components/",
    "  - Authoritative rule: packages/elm-m3e/review/src/NoProprietaryDsClasses.elm",
