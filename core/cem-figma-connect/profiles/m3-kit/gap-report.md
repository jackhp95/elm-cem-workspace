...
- code-only: 94
- figma-only: 221
- valid-but-undrawn combinations: 72 (20 matched component(s) have no axis/fusion data to evaluate — see the section below)
- unmapped axes: 61
...
| `m3e-icon-button` | shape=rounded, size=extra-large, width=default, variant=elevated | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=rounded, size=extra-large, width=default, variant=filled | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=rounded, size=extra-large, width=narrow, variant=elevated | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=rounded, size=extra-large, width=narrow, variant=filled | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=rounded, size=extra-large, width=wide, variant=elevated | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=rounded, size=extra-large, width=wide, variant=filled | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=rounded, size=extra-small, width=default, variant=elevated | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=rounded, size=extra-small, width=default, variant=filled | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=rounded, size=extra-small, width=narrow, variant=elevated | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=rounded, size=extra-small, width=narrow, variant=filled | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=rounded, size=extra-small, width=wide, variant=elevated | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=rounded, size=extra-small, width=wide, variant=filled | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=rounded, size=large, width=default, variant=elevated | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=rounded, size=large, width=default, variant=filled | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=rounded, size=large, width=narrow, variant=elevated | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=rounded, size=large, width=narrow, variant=filled | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=rounded, size=large, width=wide, variant=elevated | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=rounded, size=large, width=wide, variant=filled | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=rounded, size=medium, width=default, variant=elevated | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=rounded, size=medium, width=default, variant=filled | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=rounded, size=medium, width=narrow, variant=elevated | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=rounded, size=medium, width=narrow, variant=filled | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=rounded, size=medium, width=wide, variant=elevated | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=rounded, size=medium, width=wide, variant=filled | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=rounded, size=small, width=default, variant=elevated | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=rounded, size=small, width=default, variant=filled | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=rounded, size=small, width=narrow, variant=elevated | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=rounded, size=small, width=narrow, variant=filled | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=rounded, size=small, width=wide, variant=elevated | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=rounded, size=small, width=wide, variant=filled | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=square, size=extra-large, width=default, variant=elevated | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=square, size=extra-large, width=default, variant=filled | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=square, size=extra-large, width=narrow, variant=elevated | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=square, size=extra-large, width=narrow, variant=filled | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=square, size=extra-large, width=wide, variant=elevated | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=square, size=extra-large, width=wide, variant=filled | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=square, size=extra-small, width=default, variant=elevated | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=square, size=extra-small, width=default, variant=filled | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=square, size=extra-small, width=narrow, variant=elevated | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=square, size=extra-small, width=narrow, variant=filled | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=square, size=extra-small, width=wide, variant=elevated | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=square, size=extra-small, width=wide, variant=filled | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=square, size=large, width=default, variant=elevated | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=square, size=large, width=default, variant=filled | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=square, size=large, width=narrow, variant=elevated | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=square, size=large, width=narrow, variant=filled | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=square, size=large, width=wide, variant=elevated | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=square, size=large, width=wide, variant=filled | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=square, size=medium, width=default, variant=elevated | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=square, size=medium, width=default, variant=filled | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=square, size=medium, width=narrow, variant=elevated | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=square, size=medium, width=narrow, variant=filled | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=square, size=medium, width=wide, variant=elevated | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=square, size=medium, width=wide, variant=filled | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=square, size=small, width=default, variant=elevated | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=square, size=small, width=default, variant=filled | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=square, size=small, width=narrow, variant=elevated | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=square, size=small, width=narrow, variant=filled | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=square, size=small, width=wide, variant=elevated | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
| `m3e-icon-button` | shape=square, size=small, width=wide, variant=filled | cartesian over shape × size × width × variant (sizes: shape=2, size=5, width=3, variant=5) includes this combination, but no captured Figma axis/fusion data confirms it was drawn |
