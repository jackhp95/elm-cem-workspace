...
export const DEFAULT_TREES = [
  { name: "elm-m3e", srcPath: "packages/elm-m3e/src", dest: "vendor/elm-m3e" },
  {
    name: "elm-html-ir",
    srcPath: "packages/elm-html-intermediate-representation/src",
    dest: "vendor/elm-html-ir",
  },
  { name: "cem-facts", srcPath: "packages/elm-cem/facts/src", dest: "vendor/cem-facts" },
];
