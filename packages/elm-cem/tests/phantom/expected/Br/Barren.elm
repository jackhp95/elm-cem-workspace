module Br.Barren exposing
    ( view, build, toElement
    , Is, Attrs, Content, ChildAdmittedBy, Builder, AttrCaps, SlotCaps
    , count, label
    , child
    , withChild, withClass, withCount, withId, withLabel, withSlot, withStyle
    )
...
@docs count, label
@docs child
@docs withChild, withClass, withCount, withId, withLabel, withSlot, withStyle

-}

import Br.Attributes as A
import Br.Build.Internal as B
import Br.Html as H
...
{-| Pipe form of `count` — consumes its capability (write-once).
-}
withCount : Float -> Builder { a | count : Available } slotCaps msg -> Builder { a | count : Used } slotCaps msg
withCount value_ =
