 ...
 * m3e-card -> M3e.Component.Card.component (elmSurface: "top", surface Standard).
...
export default {
  example: figma.code`M3e.Component.Card.component
    [ M3e.Component.Card.orientation M3e.Values.horizontal
    , M3e.Component.Card.variant ${variant}
    , M3e.Component.Card.inline ""
    ]
