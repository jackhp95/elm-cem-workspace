module Sl.Build.Alert exposing (Builder, AttrCaps, SlotCaps, Is, ChildAdmittedBy, build, toElement, withClass, withClosable, withCountdown, withDuration, withId, withOnAfterHide, withOnAfterShow, withOnHide, withOnShow, withOpen, withSlot, withStyle, withVariant, withChild)
...
@docs Builder, AttrCaps, SlotCaps, Is, ChildAdmittedBy, build, toElement, withClass, withClosable, withCountdown, withDuration, withId, withOnAfterHide, withOnAfterShow, withOnHide, withOnShow, withOpen, withSlot, withStyle, withVariant, withChild
