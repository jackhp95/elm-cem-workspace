module Sl.Build.ProgressBar exposing (Builder, AttrCaps, SlotCaps, Is, Content, ChildAdmittedBy, build, toElement, withClass, withId, withIndeterminate, withLabel, withSlot, withStyle, withValue, withChild)
...
@docs Builder, AttrCaps, SlotCaps, Is, Content, ChildAdmittedBy, build, toElement, withClass, withId, withIndeterminate, withLabel, withSlot, withStyle, withValue, withChild
