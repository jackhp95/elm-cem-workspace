module Sl.Build.Drawer exposing (Builder, AttrCaps, SlotCaps, Is, ChildAdmittedBy, build, toElement, withClass, withContained, withId, withLabel, withNoHeader, withOnAfterHide, withOnAfterShow, withOnHide, withOnInitialFocus, withOnRequestClose, withOnShow, withOpen, withPlacement, withSlot, withStyle, withChild)
...
@docs Builder, AttrCaps, SlotCaps, Is, ChildAdmittedBy, build, toElement, withClass, withContained, withId, withLabel, withNoHeader, withOnAfterHide, withOnAfterShow, withOnHide, withOnInitialFocus, withOnRequestClose, withOnShow, withOpen, withPlacement, withSlot, withStyle, withChild
