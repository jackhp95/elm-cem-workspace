...
builder surface, sourced through `Sl.Component.Carousel`
...
import Sl.Component.Carousel as Component
...
{-| -}
type alias Is s =
    Component.CarouselIs s


{-| -}
type alias Builder attrCaps slotCaps msg kind =
    Component.CarouselBuilder attrCaps slotCaps msg kind


{-| -}
type alias AttrCaps =
    Component.CarouselAttrCaps


{-| -}
type alias SlotCaps =
    Component.CarouselSlotCaps


{-| -}
type alias ChildAdmittedBy childAdm =
    Component.CarouselChildAdmittedBy childAdm
...
{-| -}
withOrientation : Value Component.CarouselOrientation -> Builder { a | orientation : Available } slotCaps msg kind -> Builder { a | orientation : Used } slotCaps msg kind
withOrientation value_ =
    B.withAttribute (Component.carouselOrientation value_)
