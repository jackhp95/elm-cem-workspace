...
facts =
    [ { component = "a"
      ...
      , slotRewrites = []
      , slotKinds = [ ( "unnamed", [ "a", "circle", "clipPath", "defs", "desc", "ellipse", "filter", "foreignObject", "g", "image", "line", "linearGradient", "marker", "mask", "metadata", "path", "pattern", "polygon", "polyline", "radialGradient", "rect", "svg", "switch", "symbol", "text", "title", "use", "view" ] ) ]
      , slotUpgrades = []
      , groupConstructors = []
