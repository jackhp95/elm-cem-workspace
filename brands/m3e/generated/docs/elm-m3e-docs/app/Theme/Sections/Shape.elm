...
-}
staticPreview : Element (TypedHtml.Element.Grouping.DivIs s) admittedBy Msg
staticPreview =
...
swatchBox : String -> String -> Element (TypedHtml.Element.Grouping.DivIs s) admittedBy Msg
