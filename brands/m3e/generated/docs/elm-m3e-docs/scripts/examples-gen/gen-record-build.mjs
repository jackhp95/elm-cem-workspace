...
const SRC_DIRS = [`${REPO}/src`, `${REPO}/../../docs/elm-m3e-docs/kit`];
const ELM_BIN = `${REPO}/../../docs/elm-m3e-docs/node_modules/.bin/elm`;
const REVIEW_BIN = `${REPO}/../../docs/elm-m3e-docs/node_modules/.bin/elm-review`;
...
function runRule(items, { imports, ruleExpr, key }) {
  ...
  writeReviewConfig(cfgDir, {
    ...
    reviewElm,
    extraSourceDirs: [`${REPO}/src`, `${REPO}/../../../../../pipeline/elm-review-cem/src`],
