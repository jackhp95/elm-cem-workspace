...
const M3E_ROOT = resolve(dirname(fileURLToPath(import.meta.url)), "..", "..", "..", "..", "package", "elm-m3e");
const LIB_SRC = `${M3E_ROOT}/src`;
const ELM_BIN = `${M3E_ROOT}/../../docs/elm-m3e-docs/node_modules/.bin/elm`;
...
const DOCS_DIR = `${M3E_ROOT}/../../docs/elm-m3e-docs`;
