...
const REPO = resolve(HERE, "..", "..", "..", "package", "elm-m3e");
...
const OUT = resolve(REPO, "..", "..", "docs", "elm-m3e-docs", "data", "roundtrip-report.json");
...
const LAYER1_OUT = resolve(REPO, "..", "..", "docs", "elm-m3e-docs", "data", "roundtrip-layer1.json");
...
function runLayer2(cells) {
  ...
  try {
    ...
    execFileSync("npm", ["run", "build:ci"], { cwd: resolve(REPO, "..", "..", "docs", "elm-m3e-docs"), stdio: "inherit" });
    // 3. Read the pre-rendered harness HTML.
    const html = readFileSync(resolve(REPO, "..", "..", "docs", "elm-m3e-docs", "dist", "roundtrip-harness", "index.html"), "utf8");
