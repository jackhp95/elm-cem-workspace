...
// tools/lib/gen-facts-runner.mjs (this file used to duplicate m3e-okf's
// gen-facts.mjs byte-for-byte — Theme 3 of the 2026-08-17 audit).
//
...
const repoRoot = path.dirname(path.dirname(path.dirname(path.dirname(path.dirname(pkgDir)))));
...
runGenFacts({
    ...
    tmpPrefix: "tailwind-m3e-web-gen-facts-",
});
