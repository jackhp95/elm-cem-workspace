module M3e.Build.TimepickerToggle exposing (Builder, AttrCaps, SlotCaps, Is, ChildAdmittedBy, build, toElement, withClass, withFor, withId, withSlot, withStyle)

{-| The **TimepickerToggle** element — the flat per-element builder surface,
