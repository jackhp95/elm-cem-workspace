module M3e.Build.StepperReset exposing (Builder, AttrCaps, SlotCaps, Is, ChildAdmittedBy, build, toElement, withClass, withId, withSlot, withStyle, withChild)

{-| The **StepperReset** element — the flat per-element builder surface,
...
{-| -}
toElement : Builder attrCaps slotCaps msg kind -> Element (Component.ResetIs kind) admittedBy msg
toElement =
    B.toElement
