module M3e.Build.DialogAction exposing (Builder, AttrCaps, SlotCaps, Is, ChildAdmittedBy, build, toElement, withClass, withId, withReturnValue, withSlot, withStyle, withChild)

{-| The **DialogAction** element — the flat per-element builder surface,
sourced through the **Dialog** family façade
(`M3e.Component.Dialog`). This module and the aggregated
`M3e.Build.Dialog` are both first-class, permanent surfaces
(DAG-rework OQ-3/OQ-4).

@docs Builder, AttrCaps, SlotCaps, Is, ChildAdmittedBy, build, toElement, withClass, withId, withReturnValue, withSlot, withStyle, withChild
