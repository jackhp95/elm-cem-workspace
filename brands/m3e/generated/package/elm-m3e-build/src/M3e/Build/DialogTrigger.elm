module M3e.Build.DialogTrigger exposing (Builder, AttrCaps, SlotCaps, Is, ChildAdmittedBy, build, toElement, withClass, withFor, withId, withSlot, withStyle)

{-| The **DialogTrigger** element — the flat per-element builder surface,
