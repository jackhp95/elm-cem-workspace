module M3e.Build.FabMenuTrigger exposing (Builder, AttrCaps, SlotCaps, Is, ChildAdmittedBy, build, toElement, withClass, withFor, withId, withSlot, withStyle)

{-| The **FabMenuTrigger** element — the flat per-element builder surface,
