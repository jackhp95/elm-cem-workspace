module M3e.Build.ChipSet exposing (Builder, AttrCaps, SlotCaps, Is, Content, ChildAdmittedBy, build, toElement, withClass, withId, withSlot, withStyle, withVertical, withChild)

{-| The **ChipSet** element — the flat per-element builder surface,
...
@docs Builder, AttrCaps, SlotCaps, Is, Content, ChildAdmittedBy, build, toElement, withClass, withId, withSlot, withStyle, withVertical, withChild
...
{-| -}
toElement : Builder attrCaps slotCaps msg kind -> Element (Component.SetIs kind) admittedBy msg
toElement =
    B.toElement
