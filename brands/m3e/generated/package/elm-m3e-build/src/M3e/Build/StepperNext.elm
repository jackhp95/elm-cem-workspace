module M3e.Build.StepperNext exposing (Builder, AttrCaps, SlotCaps, Is, ChildAdmittedBy, build, toElement, withClass, withId, withSlot, withStyle)

{-| The **StepperNext** element — the flat per-element builder surface,
...
{-| -}
toElement : Builder attrCaps slotCaps msg kind -> Element (Component.NextIs kind) admittedBy msg
toElement =
    B.toElement
