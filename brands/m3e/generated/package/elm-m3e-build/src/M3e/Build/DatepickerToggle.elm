module M3e.Build.DatepickerToggle exposing (Builder, AttrCaps, SlotCaps, Is, ChildAdmittedBy, build, toElement, withClass, withFor, withId, withSlot, withStyle)

{-| The **DatepickerToggle** element — the flat per-element builder surface,
sourced through the **Datepicker** family façade
(`M3e.Component.Datepicker`). This module and the aggregated
`M3e.Build.Datepicker` are both first-class, permanent surfaces
