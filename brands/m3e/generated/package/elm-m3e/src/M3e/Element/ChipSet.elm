module M3e.Element.ChipSet exposing
    ( component
...
<!-- elm-cem:docmeta figmaUrl=https://www.figma.com/design/UtwpUdPiOZEuxp8Nq1d5yQ/Material-3-Design-Kit--Community-?node-id=57376-5501; figmaStatus=example-verified -->
