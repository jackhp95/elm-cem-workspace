module M3e.Element.Calendar exposing
    ( component
...
```elm
[ M3e.Element.Calendar.component [ M3e.Attributes.id "calendar", M3e.Element.Calendar.date "2026-01-01" ] []
...
```elm
M3e.Element.Calendar.component [ M3e.Element.Calendar.startAt "2026-01-01" ] []
```

<!-- elm-cem:example title="Start view" -->
```elm
M3e.Element.Calendar.component [ M3e.Element.Calendar.startView M3e.Values.multiYear ] []
```

<!-- elm-cem:example title="Date ranges" -->
```elm
M3e.Element.Calendar.component [ M3e.Element.Calendar.rangeStart "2026-01-01", M3e.Element.Calendar.rangeEnd "2026-01-09", M3e.Element.Calendar.startAt "2026-01-01" ] []
```

<!-- elm-cem:example title="Min and max dates" -->
```elm
M3e.Element.Calendar.component [ M3e.Element.Calendar.startAt "2026-04-01", M3e.Element.Calendar.minDate "2026-01-01", M3e.Element.Calendar.maxDate "2026-04-30" ] []
```

<!-- elm-cem:example title="Blackout dates" -->
```elm
M3e.Element.Calendar.component [ M3e.Attributes.id "blackout-dates" ] []
```

<!-- elm-cem:example title="Special dates" -->
```elm
M3e.Element.Calendar.component [ M3e.Attributes.id "special-dates", M3e.Element.Calendar.startAt "2026-04-01" ] []
```
