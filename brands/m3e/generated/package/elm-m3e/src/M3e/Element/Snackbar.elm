module M3e.Element.Snackbar exposing
    ( component
...
```elm
M3e.Element.Button.component { content = M3e.text "Delete file", action = M3e.Action.none } [ M3e.Attributes.id "example1" ] []
```

<!-- elm-cem:example title="Actions" -->
```elm
M3e.Element.Button.component { content = M3e.text "Delete file", action = M3e.Action.none } [ M3e.Attributes.id "example2" ] []
```

<!-- elm-cem:example title="Dismissal" -->
```elm
M3e.Element.Button.component { content = M3e.text "Delete file", action = M3e.Action.none } [ M3e.Attributes.id "example3" ] []
```
