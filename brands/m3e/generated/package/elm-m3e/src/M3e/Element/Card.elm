module M3e.Element.Card exposing
    ( component
...
```elm
M3e.Element.Card.component [] [ M3e.Element.Card.header (M3e.Element.Heading.component { content = M3e.text "Card Header" } [ M3e.Element.Heading.variant M3e.Values.display, M3e.Element.Heading.size M3e.Values.small ] []), M3e.Element.Card.content (TypedHtml.div [] [ M3e.text "Card Content" ]), M3e.Element.Card.actions (TypedHtml.div [ TypedHtml.Unsafe.Attributes.customAttribute "end" "" ] [ M3e.Element.Button.component { content = M3e.text "Action", action = M3e.Action.none } [ M3e.Element.Button.variant M3e.Values.filled ] [] ]) ]
```

<!-- elm-cem:example title="Card Header (2)" -->
```elm
M3e.Element.Card.component [] [ M3e.text "Card content" ]
```

<!-- elm-cem:example title="Variants" -->
```elm
[ M3e.Element.Card.component [ M3e.Element.Card.variant M3e.Values.filled ] [ M3e.Element.Card.content (TypedHtml.div [] [ M3e.text "Filled" ]) ]
    , TypedHtml.br [] []
    , M3e.Element.Card.component [ M3e.Element.Card.variant M3e.Values.outlined ] [ M3e.Element.Card.content (TypedHtml.div [] [ M3e.text "Outlined" ]) ]
    , TypedHtml.br [] []
    , M3e.Element.Card.component [ M3e.Element.Card.variant M3e.Values.elevated ] [ M3e.Element.Card.content (TypedHtml.div [] [ M3e.text "Elevated" ]) ]
    ]
```

<!-- elm-cem:example title="Inline" -->
```elm
M3e.Element.Card.component [ M3e.Element.Card.inline True ] [ M3e.Element.Card.content (TypedHtml.div [] [ M3e.text "Inline" ]) ]
```

<!-- elm-cem:example title="Orientation" -->
```elm
M3e.Element.Card.component [ M3e.Attributes.class "image-card", M3e.Element.Card.inline True, M3e.Element.Card.orientation M3e.Values.horizontal ] [ M3e.Element.Card.header (TypedHtml.img [ TypedHtml.Unsafe.Attributes.customAttribute "src" "https://www.shutterstock.com/shutterstock/videos/1006393/thumb/1.jpg?ip=x480" ] []), M3e.Element.Card.content (TypedHtml.div [] [ M3e.text "Horizontal" ]) ]
```

<!-- elm-cem:example title="Actionable" -->
```elm
[ M3e.Element.Card.component [ M3e.Element.Card.variant M3e.Values.filled, M3e.Element.Card.actionable True ] [ M3e.Element.Card.content (TypedHtml.div [] [ M3e.text "Filled Actionable" ]) ]
    , TypedHtml.br [] []
    , M3e.Element.Card.component [ M3e.Element.Card.variant M3e.Values.outlined, M3e.Element.Card.actionable True ] [ M3e.Element.Card.content (TypedHtml.div [] [ M3e.text "Outlined Actionable" ]) ]
    , TypedHtml.br [] []
    , M3e.Element.Card.component [ M3e.Element.Card.variant M3e.Values.elevated, M3e.Element.Card.actionable True ] [ M3e.Element.Card.content (TypedHtml.div [] [ M3e.text "Elevated Actionable" ]) ]
    ]
```

<!-- elm-cem:example title="Disabling" -->
```elm
[ M3e.Element.Card.component [ M3e.Element.Card.variant M3e.Values.filled, M3e.Element.Card.actionable True, M3e.Element.Card.disabled True ] [ M3e.Element.Card.content (TypedHtml.div [] [ M3e.text "Disabled" ]) ]
    , TypedHtml.br [] []
    , M3e.Element.Card.component [ M3e.Element.Card.variant M3e.Values.filled, M3e.Element.Card.actionable True, M3e.Element.Card.disabledInteractive True ] [ M3e.Element.Card.content (TypedHtml.div [] [ M3e.text "Disabled Interactive" ]) ]
    ]
```

<!-- elm-cem:example title="Links" -->
```elm
M3e.Element.Card.component [ M3e.Element.Card.actionable True, M3e.Element.Card.href "https://www.google.com", M3e.Element.Card.target "_blank" ] [ M3e.Element.Card.content (TypedHtml.div [] [ M3e.text "Google" ]) ]
```

<!-- elm-cem:docmeta category=Containment; figmaUrl=https://www.figma.com/design/UtwpUdPiOZEuxp8Nq1d5yQ/Material-3-Design-Kit--Community-?node-id=52346-27573; figmaStatus=example-verified -->
