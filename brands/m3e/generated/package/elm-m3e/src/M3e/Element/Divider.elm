module M3e.Element.Divider exposing
    ( component
...
[ M3e.Element.Divider.component [] []
    , TypedHtml.br [] []
    , M3e.Element.Divider.component [ M3e.Element.Divider.inset True ] []
    , TypedHtml.br [] []
    , M3e.Element.Divider.component [ M3e.Element.Divider.insetStart True ] []
    , TypedHtml.br [] []
    , M3e.Element.Divider.component [ M3e.Element.Divider.insetEnd True ] []
    ]
```

<!-- elm-cem:example title="Orientation" -->
```elm
[ M3e.Element.Divider.component [ M3e.Element.Divider.vertical True ] []
    , M3e.Element.Divider.component [ M3e.Element.Divider.vertical True, M3e.Element.Divider.inset True ] []
    , M3e.Element.Divider.component [ M3e.Element.Divider.vertical True, M3e.Element.Divider.insetStart True ] []
    , M3e.Element.Divider.component [ M3e.Element.Divider.vertical True, M3e.Element.Divider.insetEnd True ] []
    ]
```
