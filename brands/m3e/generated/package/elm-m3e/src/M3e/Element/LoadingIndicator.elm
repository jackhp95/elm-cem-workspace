module M3e.Element.LoadingIndicator exposing
    ( component
...
```elm
[ M3e.Element.LoadingIndicator.component [] []
    , M3e.Element.LoadingIndicator.component [ M3e.Element.LoadingIndicator.variant M3e.Values.contained ] []
    ]
```

<!-- elm-cem:docmeta category=Communication; figmaUrl=https://www.figma.com/design/UtwpUdPiOZEuxp8Nq1d5yQ/Material-3-Design-Kit--Community-?node-id=58005-8555; figmaStatus=example-verified -->
