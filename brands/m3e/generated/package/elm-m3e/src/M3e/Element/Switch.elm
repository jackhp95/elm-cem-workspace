module M3e.Element.Switch exposing
    ( component
...
```elm
M3e.Element.Switch.component [ M3e.Element.Switch.checked True ] []
```

<!-- elm-cem:example title="Labels" -->
```elm
[ M3e.Unsafe.customElement "label" [] [ M3e.Element.Switch.component [] [], M3e.text "Switch 1" ]
    , M3e.Element.Switch.component [ M3e.Attributes.id "switch2" ] []
...
```elm
[ M3e.Unsafe.customElement "label" [] [ M3e.Element.Switch.component [ M3e.Element.Switch.disabled True ] [], M3e.text "Disabled Switch 1" ]
    , M3e.Element.Switch.component [ M3e.Attributes.id "chk3", M3e.Element.Switch.disabled True ] []
...
```elm
[ M3e.Element.Switch.component [ M3e.Attributes.class "density-3" ] []
    , M3e.Element.Switch.component [ M3e.Attributes.class "density-2" ] []
    , M3e.Element.Switch.component [ M3e.Attributes.class "density-1" ] []
    , M3e.Element.Switch.component [ M3e.Attributes.class "density-0" ] []
    ]
```
...
```elm
[ M3e.Element.Switch.component [ M3e.Element.Switch.icons M3e.Values.selected, M3e.Element.Switch.checked True ] []
    , M3e.Element.Switch.component [ M3e.Element.Switch.icons M3e.Values.both ] []
    ]
```
