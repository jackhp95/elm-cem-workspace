module M3e.Element.AppBar exposing
    ( component
...
```elm
M3e.Element.AppBar.component [] [ M3e.Element.AppBar.leading (M3e.Element.IconButton.component { content = M3e.Element.Icon.component [ M3e.Element.Icon.name "arrow_back" ] [], ariaLabel = "Back", action = M3e.Action.none } [] []), M3e.Element.AppBar.title (M3e.text "Top 10 hiking trails"), M3e.Element.AppBar.subtitle (M3e.text "Discover popular trails"), M3e.Element.AppBar.trailing (M3e.Element.IconButton.component { content = M3e.Element.Icon.component [ M3e.Element.Icon.name "bookmark", M3e.Element.Icon.filled True ] [], ariaLabel = "Bookmark", action = M3e.Action.none } [ M3e.Element.IconButton.variant M3e.Values.tonal ] []) ]
```

<!-- elm-cem:example title="Sizes" -->
```elm
M3e.Element.AppBar.component [ M3e.Element.AppBar.size M3e.Values.medium ] [ M3e.Element.AppBar.leading (M3e.Element.IconButton.component { content = M3e.Element.Icon.component [ M3e.Element.Icon.name "arrow_back" ] [], ariaLabel = "Back", action = M3e.Action.none } [] []), M3e.Element.AppBar.title (M3e.text "Top 10 hiking trails"), M3e.Element.AppBar.subtitle (M3e.text "Discover popular trails"), M3e.Element.AppBar.trailing (M3e.Element.IconButton.component { content = M3e.Element.Icon.component [ M3e.Element.Icon.name "bookmark", M3e.Element.Icon.filled True ] [], ariaLabel = "Bookmark", action = M3e.Action.none } [ M3e.Element.IconButton.variant M3e.Values.tonal ] []) ]
```

<!-- elm-cem:example title="Sizes (2)" -->
```elm
M3e.Element.AppBar.component [ M3e.Element.AppBar.size M3e.Values.large ] [ M3e.Element.AppBar.leading (M3e.Element.IconButton.component { content = M3e.Element.Icon.component [ M3e.Element.Icon.name "arrow_back" ] [], ariaLabel = "Back", action = M3e.Action.none } [] []), M3e.Element.AppBar.title (M3e.text "Top 10 hiking trails"), M3e.Element.AppBar.subtitle (M3e.text "Discover popular trails"), M3e.Element.AppBar.trailing (M3e.Element.IconButton.component { content = M3e.Element.Icon.component [ M3e.Element.Icon.name "bookmark", M3e.Element.Icon.filled True ] [], ariaLabel = "Bookmark", action = M3e.Action.none } [ M3e.Element.IconButton.variant M3e.Values.tonal ] []) ]
```

<!-- elm-cem:example title="Centered" -->
```elm
M3e.Element.AppBar.component [ M3e.Element.AppBar.centered True ] [ M3e.Element.AppBar.leading (M3e.Element.IconButton.component { content = M3e.Element.Icon.component [ M3e.Element.Icon.name "arrow_back" ] [], ariaLabel = "Back", action = M3e.Action.none } [] []), M3e.Element.AppBar.title (M3e.text "Top 10 hiking trails"), M3e.Element.AppBar.subtitle (M3e.text "Discover popular trails"), M3e.Element.AppBar.trailing (M3e.Element.IconButton.component { content = M3e.Element.Icon.component [ M3e.Element.Icon.name "bookmark" ] [], ariaLabel = "Bookmark", action = M3e.Action.none } [] []), M3e.Element.AppBar.trailing (M3e.Element.IconButton.component { content = M3e.Element.Icon.component [ M3e.Element.Icon.name "help" ] [], ariaLabel = "help", action = M3e.Action.none } [] []) ]
```

<!-- elm-cem:example title="Scroll effects" -->
```elm
TypedHtml.div [ TypedHtml.Unsafe.Attributes.customAttribute "id" "scrollContainer" ] [ M3e.Element.AppBar.component [ M3e.Element.AppBar.for "scrollContainer" ] [ M3e.Element.AppBar.leading (M3e.Element.IconButton.component { content = M3e.Element.Icon.component [ M3e.Element.Icon.name "arrow_back" ] [], ariaLabel = "Back", action = M3e.Action.none } [] []), M3e.Element.AppBar.title (M3e.text "Top 10 hiking trails"), M3e.Element.AppBar.subtitle (M3e.text "Discover popular trails"), M3e.Element.AppBar.trailing (M3e.Element.IconButton.component { content = M3e.Element.Icon.component [ M3e.Element.Icon.name "bookmark", M3e.Element.Icon.filled True ] [], ariaLabel = "Bookmark", action = M3e.Action.none } [ M3e.Element.IconButton.variant M3e.Values.tonal ] []) ], TypedHtml.div [ TypedHtml.Unsafe.Attributes.customAttribute "class" "scroll-item" ] [ M3e.text "Scroll down to see the elevation effect" ] ]
```
