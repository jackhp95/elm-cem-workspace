module M3e.Element.SplitPane exposing
    ( component
...
```elm
M3e.Element.SplitPane.component { end = M3e.Element.Card.component [] [], start = M3e.Element.Card.component [] [] } [ M3e.Element.SplitPane.value 50 ] []
```

<!-- elm-cem:example title="Orientation" -->
```elm
M3e.Element.SplitPane.component { end = M3e.Element.Card.component [] [], start = M3e.Element.Card.component [] [] } [ M3e.Element.SplitPane.value 50, M3e.Element.SplitPane.orientation M3e.Values.vertical ] []
```

<!-- elm-cem:example title="Min and max sizes" -->
```elm
M3e.Element.SplitPane.component { end = M3e.Element.Card.component [] [], start = M3e.Element.Card.component [] [] } [ M3e.Element.SplitPane.value 50, M3e.Element.SplitPane.min 25, M3e.Element.SplitPane.max 75 ] []
```

<!-- elm-cem:example title="Step size" -->
```elm
M3e.Element.SplitPane.component { end = M3e.Element.Card.component [] [], start = M3e.Element.Card.component [] [] } [ M3e.Element.SplitPane.value 50, M3e.Element.SplitPane.step 10 ] []
```

<!-- elm-cem:example title="Detents" -->
```elm
M3e.Element.SplitPane.component { end = M3e.Element.Card.component [] [], start = M3e.Element.Card.component [] [] } [ M3e.Element.SplitPane.value 50, M3e.Element.SplitPane.detents "0 25 50 75 100", M3e.Element.SplitPane.wrapDetents True ] []
```

<!-- elm-cem:example title="Disabling" -->
```elm
M3e.Element.SplitPane.component { end = M3e.Element.Card.component [] [], start = M3e.Element.Card.component [] [] } [ M3e.Element.SplitPane.value 50, M3e.Element.SplitPane.disabled True ] []
```

<!-- elm-cem:example title="Conditional rendering" -->
```elm
M3e.Element.SplitPane.component { end = M3e.Element.Card.component [ TypedHtml.Unsafe.Attributes.customAttribute "hidden" "" ] [], start = M3e.Element.Card.component [] [] } [ M3e.Element.SplitPane.value 50 ] []
```

<!-- elm-cem:example title="Nested panes" -->
```elm
M3e.Element.SplitPane.component { end = M3e.Element.SplitPane.component { end = M3e.Element.Card.component [] [], start = M3e.Element.Card.component [] [] } [ M3e.Element.SplitPane.value 50, M3e.Element.SplitPane.orientation M3e.Values.vertical ] [], start = M3e.Element.Card.component [] [] } [ M3e.Element.SplitPane.value 25, M3e.Attributes.class "complex" ] []
```
