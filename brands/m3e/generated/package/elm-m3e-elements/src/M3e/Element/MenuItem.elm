module M3e.Element.MenuItem exposing
    ( component
...
<!-- elm-cem:docmeta figmaUrl=https://www.figma.com/design/UtwpUdPiOZEuxp8Nq1d5yQ/Material-3-Design-Kit--Community-?node-id=58966-4100; figmaStatus=example-verified -->
