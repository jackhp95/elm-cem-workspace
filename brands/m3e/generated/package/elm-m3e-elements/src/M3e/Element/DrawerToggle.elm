module M3e.Element.DrawerToggle exposing
    ( component
...
{-| The kind row `m3e-drawer-toggle` produces (open — composes into any slot naming it).
-}
type alias Is s =
...
-}
type alias Attrs =
    M3e.Internal.Types.DrawerToggle.Attrs
