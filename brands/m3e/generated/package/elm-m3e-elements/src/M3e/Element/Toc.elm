module M3e.Element.Toc exposing
    ( component
...
```elm
M3e.Element.Toc.component [ M3e.Element.Toc.for "d1" ] [ M3e.Element.Toc.overline (M3e.text "Overline"), M3e.Element.Toc.title (M3e.text "Title") ]
```
