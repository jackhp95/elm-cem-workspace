module M3e.Element.Dialog exposing
    ( component
...
```elm
[ M3e.Element.Button.component { content = M3e.Element.DialogTrigger.component [ M3e.Element.DialogTrigger.for "dlg" ] [ M3e.text "Open Dialog" ], action = M3e.Action.none } [ M3e.Element.Button.variant M3e.Values.filled ] []
    , M3e.Element.Dialog.component [ M3e.Attributes.id "dlg", M3e.Element.Dialog.dismissible True ] [ M3e.Element.Dialog.header (M3e.text "Lorem ipsum dolor sit amet"), M3e.text "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et\n  dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex\n  ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu\n  fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt\n  mollit anim id est laborum.", M3e.Element.Dialog.actions (TypedHtml.div [ TypedHtml.Unsafe.Attributes.customAttribute "end" "" ] [ M3e.Element.Button.component { content = M3e.Element.DialogAction.component [ M3e.Element.DialogAction.returnValue "ok" ] [ M3e.text "Close" ], action = M3e.Action.none } [ TypedHtml.Unsafe.Attributes.customAttribute "autofocus" "" ] [] ]) ]
    ]
```
...
```elm
[ M3e.Element.Button.component { content = M3e.Element.DialogTrigger.component [ M3e.Element.DialogTrigger.for "dlg" ] [ M3e.text "Open Dialog" ], action = M3e.Action.none } [ M3e.Element.Button.variant M3e.Values.filled ] []
    , M3e.Element.Dialog.component [ M3e.Attributes.id "dlg", M3e.Element.Dialog.dismissible True ] []
    ]
```

<!-- elm-cem:example title="Actions" -->
```elm
M3e.Element.Button.component { content = M3e.Element.DialogAction.component [ M3e.Element.DialogAction.returnValue "ok" ] [ M3e.text "Close" ], action = M3e.Action.none } [] []
```
