module M3e.Element.Paginator exposing
    ( component
...
```elm
M3e.Element.Paginator.component [ M3e.Element.Paginator.length 100 ] []
```

<!-- elm-cem:example title="Page sizes" -->
```elm
M3e.Element.Paginator.component [ M3e.Element.Paginator.length 100, M3e.Element.Paginator.pageSizes "10,50,all", M3e.Element.Paginator.pageSize "all" ] []
```

<!-- elm-cem:example title="Navigation actions" -->
```elm
M3e.Element.Paginator.component [ M3e.Element.Paginator.length 100, M3e.Element.Paginator.showFirstLastButtons True ] []
```

<!-- elm-cem:example title="Density" -->
```elm
M3e.Element.Paginator.component [ M3e.Attributes.class "density-3", M3e.Element.Paginator.length 100, M3e.Element.Paginator.showFirstLastButtons True ] []
```
