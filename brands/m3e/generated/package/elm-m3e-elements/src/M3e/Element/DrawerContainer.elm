module M3e.Element.DrawerContainer exposing
    ( component
...
```elm
M3e.Element.DrawerContainer.component [] [ M3e.Element.DrawerContainer.start (TypedHtml.div [] [ M3e.text "Start drawer" ]), TypedHtml.div [] [ M3e.text "Main content" ], M3e.Element.DrawerContainer.end (TypedHtml.div [] [ M3e.text "End drawer" ]) ]
```

<!-- elm-cem:example title="Sizes" -->
```elm
M3e.Element.DrawerContainer.component [] [ M3e.Element.DrawerContainer.start (TypedHtml.div [ TypedHtml.Unsafe.Attributes.customAttribute "style" "width: 200px" ] [ M3e.text "Start drawer" ]), TypedHtml.div [] [ M3e.text "Main content" ] ]
```

<!-- elm-cem:example title="Modes" -->
```elm
M3e.Element.DrawerContainer.component [ M3e.Element.DrawerContainer.startMode M3e.Values.push ] [ M3e.Element.DrawerContainer.start (TypedHtml.div [] [ M3e.text "Start drawer" ]), TypedHtml.div [] [ M3e.text "Main content" ] ]
```

<!-- elm-cem:example title="Modes (2)" -->
```elm
M3e.Element.DrawerContainer.component [ M3e.Element.DrawerContainer.startMode M3e.Values.over ] [ M3e.Element.DrawerContainer.start (TypedHtml.div [] [ M3e.text "Start drawer" ]), TypedHtml.div [] [ M3e.text "Main content" ] ]
```

<!-- elm-cem:example title="Dividers" -->
```elm
M3e.Element.DrawerContainer.component [ M3e.Element.DrawerContainer.endMode M3e.Values.side, M3e.Element.DrawerContainer.endDivider True ] [ TypedHtml.div [] [ M3e.text "Main content" ], M3e.Element.DrawerContainer.end (TypedHtml.div [] [ M3e.text "End drawer" ]) ]
```

<!-- elm-cem:example title="Toggle" -->
```elm
[ M3e.Element.IconButton.component { content = M3e.Element.Icon.component [ M3e.Element.Icon.name "menu" ] [], ariaLabel = "Menu", action = M3e.Action.none } [ M3e.Element.IconButton.toggle True ] [ M3e.Element.IconButton.selected (M3e.Element.Icon.component [ M3e.Element.Icon.name "menu_open" ] []), M3e.Element.DrawerToggle.component [ M3e.Element.DrawerToggle.for "nav-drawer" ] [] ]
    , M3e.Element.DrawerContainer.component [ M3e.Element.DrawerContainer.startMode M3e.Values.over ] [ M3e.Element.DrawerContainer.start (TypedHtml.div [ TypedHtml.Unsafe.Attributes.customAttribute "id" "nav-drawer" ] [ M3e.text "Start drawer" ]), TypedHtml.div [] [ M3e.text "Main content" ] ]
    ]
```

<!-- elm-cem:example title="Accessibility" -->
```elm
M3e.Element.DrawerContainer.component [] [ M3e.Element.DrawerContainer.start (TypedHtml.nav [] []), TypedHtml.main_ [] [], M3e.Element.DrawerContainer.end (TypedHtml.aside [] []) ]
```
