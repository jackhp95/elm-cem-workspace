module M3e.Element.FabMenu exposing
    ( component
...
```elm
M3e.Element.FabMenuItem.component [] [ M3e.Element.FabMenuItem.icon (M3e.Element.Icon.component [ M3e.Element.Icon.name "email", M3e.Element.Icon.filled True ] []), M3e.text "Email" ]
```
