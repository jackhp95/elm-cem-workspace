module M3e.Element.Checkbox exposing
    ( component
...
```elm
[ M3e.Element.Checkbox.component [] []
    , M3e.Element.Checkbox.component [ M3e.Element.Checkbox.checked True ] []
    , M3e.Element.Checkbox.component [ M3e.Element.Checkbox.indeterminate True ] []
    ]
```

<!-- elm-cem:example title="Labels" -->
```elm
[ M3e.Unsafe.customElement "label" [] [ M3e.Element.Checkbox.component [] [], M3e.text "Checkbox 1" ]
    , M3e.Element.Checkbox.component [ M3e.Attributes.id "chk2" ] []
...
```elm
[ M3e.Unsafe.customElement "label" [] [ M3e.Element.Checkbox.component [ M3e.Element.Checkbox.disabled True ] [], M3e.text "Disabled Checkbox 1" ]
    , M3e.Element.Checkbox.component [ M3e.Attributes.id "chk3", M3e.Element.Checkbox.disabled True ] []
...
```elm
TypedHtml.form [] [ M3e.Unsafe.customElement "label" [] [ M3e.Element.Checkbox.component [ M3e.Element.Checkbox.name "accepted", M3e.Element.Checkbox.required True ] [], M3e.text "I accept the Terms and Conditions" ], TypedHtml.br [] [], M3e.Element.Button.component { content = M3e.text "Submit", action = M3e.Action.none } [ M3e.Element.Button.variant M3e.Values.filled, M3e.Element.Button.type_ M3e.Values.submit ] [] ]
```

<!-- elm-cem:example title="Density" -->
```elm
[ M3e.Unsafe.customElement "label" [] [ M3e.Element.Checkbox.component [ M3e.Attributes.class "density-3" ] [], M3e.text "Density -3" ]
    , M3e.Unsafe.customElement "label" [] [ M3e.Element.Checkbox.component [ M3e.Attributes.class "density-2" ] [], M3e.text "Density -2" ]
    , M3e.Unsafe.customElement "label" [] [ M3e.Element.Checkbox.component [ M3e.Attributes.class "density-1" ] [], M3e.text "Density -1" ]
    , M3e.Unsafe.customElement "label" [] [ M3e.Element.Checkbox.component [ M3e.Attributes.class "density-0" ] [], M3e.text "Density 0" ]
    ]
```
