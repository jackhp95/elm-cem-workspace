module M3e.Internal.Types.TabPanel exposing (Is, Attrs, ChildAdmittedBy, Builder, AttrCaps)

{-| Type definitions for TabPanel. The canonical home of this
component's `Attrs`/`Is`/`Content`/… rows: the `M3e` barrel and the strict
`M3e.Component.TabPanel` surface both re-export these, so they live in
