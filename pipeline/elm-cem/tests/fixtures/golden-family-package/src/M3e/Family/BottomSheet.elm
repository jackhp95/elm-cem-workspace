module M3e.Family.BottomSheet exposing
    ( BottomSheetIs
    , BottomSheetAttrs
    , BottomSheetBuilder
    , BottomSheetAttrCaps
    , BottomSheetSlotCaps
    , BottomSheetChildAdmittedBy
    , ActionIs
    , ActionAttrs
    , ActionBuilder
    , ActionAttrCaps
...
bottomSheetDetent :
    Float -> Attr { c | detent : Supported } msg
bottomSheetDetent =
    BottomSheet_.detent
...
bottomSheetDetents :
    String -> Attr { c | detents : Supported } msg
bottomSheetDetents =
...
bottomSheetHandle :
    Bool -> Attr { c | handle : Supported } msg
bottomSheetHandle =
    BottomSheet_.handle
...
bottomSheetHandleLabel :
    String -> Attr { c | handleLabel : Supported } msg
bottomSheetHandleLabel =
...
bottomSheetHideFriction :
    Float -> Attr { c | hideFriction : Supported } msg
bottomSheetHideFriction =
...
bottomSheetHideable :
    Bool -> Attr { c | hideable : Supported } msg
bottomSheetHideable =
...
bottomSheetModal :
    Bool -> Attr { c | modal : Supported } msg
bottomSheetModal =
    BottomSheet_.modal
...
bottomSheetOvershootLimit :
    Float -> Attr { c | overshootLimit : Supported } msg
bottomSheetOvershootLimit =
...
bottomSheetOnCancel :
    msg -> Attr { c | onCancel : Supported } msg
bottomSheetOnCancel =
...
triggerSecondary :
    Bool -> Attr { c | secondary : Supported } msg
triggerSecondary =
    Trigger_.secondary
...
triggerChild :
    Element TriggerContent admittedBy msg -> Element free freeAdmittedBy msg
triggerChild =
    Trigger_.child
