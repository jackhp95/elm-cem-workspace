module M3e.Family.FabMenu exposing
    ( FabMenuIs
    , FabMenuAttrs
    , FabMenuBuilder
    , FabMenuAttrCaps
...
{-| See [`M3e.Component.FabMenu.variant`](M3e.Component.FabMenu#variant). -}
fabMenuVariant :
    Value FabMenuVariant -> Attr { c | variant : Supported } msg
fabMenuVariant =
    FabMenu_.variant
...
fabMenuChild :
    Element FabMenuContent admittedBy msg -> Element free freeAdmittedBy msg
fabMenuChild =
    FabMenu_.child
