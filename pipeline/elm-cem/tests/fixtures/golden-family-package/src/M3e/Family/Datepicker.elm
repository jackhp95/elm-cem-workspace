module M3e.Family.Datepicker exposing
    ( DatepickerIs
    , DatepickerAttrs
    , DatepickerBuilder
    , DatepickerAttrCaps
    , DatepickerSlotCaps
    , DatepickerChildAdmittedBy
    , DatepickerStartView
    , DatepickerVariant
    , ToggleIs
    , ToggleAttrs
...
{-| See [`M3e.Component.Datepicker.startView`](M3e.Component.Datepicker#startView). -}
datepickerStartView :
    Value DatepickerStartView -> Attr { c | startView : Supported } msg
datepickerStartView =
    Datepicker_.startView
...
{-| See [`M3e.Component.Datepicker.variant`](M3e.Component.Datepicker#variant). -}
datepickerVariant :
    Value DatepickerVariant -> Attr { c | variant : Supported } msg
datepickerVariant =
    Datepicker_.variant
...
datepickerClearLabel :
    String -> Attr { c | clearLabel : Supported } msg
datepickerClearLabel =
...
datepickerClearable :
    Bool -> Attr { c | clearable : Supported } msg
datepickerClearable =
...
datepickerLabel :
    String -> Attr { c | label : Supported } msg
datepickerLabel =
    Datepicker_.label
...
datepickerMaxDate :
    String -> Attr { c | maxDate : Supported } msg
datepickerMaxDate =
    Datepicker_.maxDate
...
datepickerMinDate :
    String -> Attr { c | minDate : Supported } msg
datepickerMinDate =
    Datepicker_.minDate
...
datepickerNextMonthLabel :
    String -> Attr { c | nextMonthLabel : Supported } msg
datepickerNextMonthLabel =
...
datepickerNextMultiYearLabel :
    String -> Attr { c | nextMultiYearLabel : Supported } msg
datepickerNextMultiYearLabel =
...
datepickerNextYearLabel :
    String -> Attr { c | nextYearLabel : Supported } msg
datepickerNextYearLabel =
...
datepickerPreviousMonthLabel :
    String -> Attr { c | previousMonthLabel : Supported } msg
datepickerPreviousMonthLabel =
...
datepickerPreviousMultiYearLabel :
    String -> Attr { c | previousMultiYearLabel : Supported } msg
datepickerPreviousMultiYearLabel =
...
datepickerPreviousYearLabel :
    String -> Attr { c | previousYearLabel : Supported } msg
datepickerPreviousYearLabel =
...
datepickerRange :
    Bool -> Attr { c | range : Supported } msg
datepickerRange =
    Datepicker_.range
...
datepickerRangeEnd :
    String -> Attr { c | rangeEnd : Supported } msg
datepickerRangeEnd =
...
datepickerRangeStart :
    String -> Attr { c | rangeStart : Supported } msg
datepickerRangeStart =
...
datepickerStartAt :
    String -> Attr { c | startAt : Supported } msg
datepickerStartAt =
    Datepicker_.startAt
...
datepickerOnChange :
    (String -> msg) -> Attr { c | onChange : Supported } msg
datepickerOnChange =
