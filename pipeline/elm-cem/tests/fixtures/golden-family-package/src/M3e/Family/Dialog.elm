module M3e.Family.Dialog exposing
    ( DialogIs
    , DialogAttrs
    , DialogBuilder
    , DialogAttrCaps
...
dialogAlert :
    Bool -> Attr { c | alert : Supported } msg
dialogAlert =
    Dialog_.alert
...
dialogCloseLabel :
    String -> Attr { c | closeLabel : Supported } msg
dialogCloseLabel =
    Dialog_.closeLabel
...
dialogDisableClose :
    Bool -> Attr { c | disableClose : Supported } msg
dialogDisableClose =
...
dialogDismissible :
    Bool -> Attr { c | dismissible : Supported } msg
dialogDismissible =
    Dialog_.dismissible
...
dialogNoFocusTrap :
    Bool -> Attr { c | noFocusTrap : Supported } msg
dialogNoFocusTrap =
    Dialog_.noFocusTrap
...
dialogCloseIcon :
    Element DialogCloseIconSlot admittedBy msg -> Element free freeAdmittedBy msg
dialogCloseIcon =
    Dialog_.closeIcon
...
dialogHeader :
    Element DialogHeaderSlot admittedBy msg -> Element free freeAdmittedBy msg
dialogHeader =
    Dialog_.header
...
actionReturnValue :
    String -> Attr { c | returnValue : Supported } msg
actionReturnValue =
    Action_.returnValue
