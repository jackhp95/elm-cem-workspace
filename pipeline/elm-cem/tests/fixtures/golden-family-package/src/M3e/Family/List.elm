module M3e.Family.List exposing
    ( ListIs
    , ListAttrs
    , ListBuilder
    , ListAttrCaps
    ...
    , ActionLeadingSlot
    , ActionOverlineSlot
    , ActionSupportingTextSlot
    , ActionTrailingSlot
    , ActionChildAdmittedBy
    , OptionIs
    , OptionAttrs
    , OptionBuilder
    , OptionAttrCaps
    ...
    , OptionLeadingSlot
    , OptionOverlineSlot
    , OptionSupportingTextSlot
    , OptionTrailingSlot
    , OptionChildAdmittedBy
    , list
    , listVariant
    , listChild
    , item
...
{-| See [`M3e.Component.List.variant`](M3e.Component.List#variant). -}
listVariant :
    Value ListVariant -> Attr { c | variant : Supported } msg
listVariant =
    List_.variant
...
listChild :
    Element ListContent admittedBy msg -> Element free freeAdmittedBy msg
listChild =
    List_.child
...
itemLeading :
    Element ItemLeadingSlot admittedBy msg -> Element free freeAdmittedBy msg
itemLeading =
    Item_.leading
...
itemOverline :
    Element ItemOverlineSlot admittedBy msg -> Element free freeAdmittedBy msg
itemOverline =
    Item_.overline
...
itemSupportingText :
    Element ItemSupportingTextSlot admittedBy msg -> Element free freeAdmittedBy msg
itemSupportingText =
...
itemTrailing :
    Element ItemTrailingSlot admittedBy msg -> Element free freeAdmittedBy msg
itemTrailing =
    Item_.trailing
...
itemChild :
    Element ItemContent admittedBy msg -> Element free freeAdmittedBy msg
itemChild =
    Item_.child
...
actionLeading :
    Element ActionLeadingSlot admittedBy msg -> Element free freeAdmittedBy msg
actionLeading =
    Action_.leading
...
actionOverline :
    Element ActionOverlineSlot admittedBy msg -> Element free freeAdmittedBy msg
actionOverline =
    Action_.overline
...
actionSupportingText :
    Element ActionSupportingTextSlot admittedBy msg -> Element free freeAdmittedBy msg
actionSupportingText =
...
actionTrailing :
    Element ActionTrailingSlot admittedBy msg -> Element free freeAdmittedBy msg
actionTrailing =
    Action_.trailing
...
actionChild :
    Element ActionContent admittedBy msg -> Element free freeAdmittedBy msg
actionChild =
    Action_.child
...
optionLeading :
    Element OptionLeadingSlot admittedBy msg -> Element free freeAdmittedBy msg
optionLeading =
    Option_.leading
...
optionOverline :
    Element OptionOverlineSlot admittedBy msg -> Element free freeAdmittedBy msg
optionOverline =
    Option_.overline
...
optionSupportingText :
    Element OptionSupportingTextSlot admittedBy msg -> Element free freeAdmittedBy msg
optionSupportingText =
...
optionTrailing :
    Element OptionTrailingSlot admittedBy msg -> Element free freeAdmittedBy msg
optionTrailing =
    Option_.trailing
...
optionChild :
    Element OptionContent admittedBy msg -> Element free freeAdmittedBy msg
optionChild =
    Option_.child
