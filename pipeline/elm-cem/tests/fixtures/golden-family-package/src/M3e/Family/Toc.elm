module M3e.Family.Toc exposing
    ( TocIs
    , TocAttrs
    , TocBuilder
    , TocAttrCaps
...
tocMaxDepth :
    Float -> Attr { c | maxDepth : Supported } msg
tocMaxDepth =
    Toc_.maxDepth
...
tocOverline :
    Element TocOverlineSlot admittedBy msg -> Element free freeAdmittedBy msg
tocOverline =
    Toc_.overline
...
tocTitle :
    Element TocTitleSlot admittedBy msg -> Element free freeAdmittedBy msg
tocTitle =
    Toc_.title
