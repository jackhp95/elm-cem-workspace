module M3e.Family.Tabs exposing
    ( TabsIs
    , TabsAttrs
    , TabsBuilder
    , TabsAttrCaps
...
{-| See [`M3e.Component.Tabs.disablePagination`](M3e.Component.Tabs#disablePagination). -}
tabsDisablePagination :
    Value TabsDisablePagination -> Attr { c | disablePagination : Supported } msg
tabsDisablePagination =
    Tabs_.disablePagination
...
{-| See [`M3e.Component.Tabs.headerPosition`](M3e.Component.Tabs#headerPosition). -}
tabsHeaderPosition :
    Value TabsHeaderPosition -> Attr { c | headerPosition : Supported } msg
tabsHeaderPosition =
    Tabs_.headerPosition
...
{-| See [`M3e.Component.Tabs.variant`](M3e.Component.Tabs#variant). -}
tabsVariant :
    Value TabsVariant -> Attr { c | variant : Supported } msg
tabsVariant =
    Tabs_.variant
...
tabsNextPageLabel :
    String -> Attr { c | nextPageLabel : Supported } msg
tabsNextPageLabel =
    Tabs_.nextPageLabel
...
tabsPreviousPageLabel :
    String -> Attr { c | previousPageLabel : Supported } msg
tabsPreviousPageLabel =
...
tabsStretch :
    Bool -> Attr { c | stretch : Supported } msg
tabsStretch =
    Tabs_.stretch
...
tabsNextIcon :
    Element TabsNextIconSlot admittedBy msg -> Element free freeAdmittedBy msg
tabsNextIcon =
    Tabs_.nextIcon
...
tabsPanel :
    Element TabsPanelSlot admittedBy msg -> Element free freeAdmittedBy msg
tabsPanel =
    Tabs_.panel
...
tabsPrevIcon :
    Element TabsPrevIconSlot admittedBy msg -> Element free freeAdmittedBy msg
tabsPrevIcon =
    Tabs_.prevIcon
...
tabsChild :
    Element TabsContent admittedBy msg -> Element free freeAdmittedBy msg
tabsChild =
    Tabs_.child
...
tabIcon :
    Element TabIconSlot admittedBy msg -> Element free freeAdmittedBy msg
tabIcon =
    Tab_.icon
...
tabChild :
    Element TabContent admittedBy msg -> Element free freeAdmittedBy msg
tabChild =
    Tab_.child
