module M3e.Family.Calendar exposing
    ( CalendarIs
    , CalendarAttrs
    , CalendarBuilder
    , CalendarAttrCaps
    , CalendarSlotCaps
    , CalendarChildAdmittedBy
    , CalendarStartView
    , MonthViewIs
    , MonthViewAttrs
    , MonthViewBuilder
    , MonthViewAttrCaps
    , MonthViewSlotCaps
    , MonthViewChildAdmittedBy
    , YearViewIs
    , YearViewAttrs
    , YearViewBuilder
    , YearViewAttrCaps
    , YearViewSlotCaps
    , YearViewChildAdmittedBy
    , MultiYearViewIs
    , MultiYearViewAttrs
    , MultiYearViewBuilder
    , MultiYearViewAttrCaps
    , MultiYearViewSlotCaps
    , MultiYearViewChildAdmittedBy
    , calendar
    , calendarStartView
    , calendarDate
    , calendarMaxDate
...
{-| See [`M3e.Component.Calendar.startView`](M3e.Component.Calendar#startView). -}
calendarStartView :
    Value CalendarStartView -> Attr { c | startView : Supported } msg
calendarStartView =
    Calendar_.startView
...
monthViewActive :
    Bool -> Attr { c | active : Supported } msg
monthViewActive =
    MonthView_.active
...
monthViewActiveDate :
    String -> Attr { c | activeDate : Supported } msg
monthViewActiveDate =
...
monthViewToday :
    String -> Attr { c | today : Supported } msg
monthViewToday =
    MonthView_.today
...
monthViewOnActiveChange :
    msg -> Attr { c | onActiveChange : Supported } msg
monthViewOnActiveChange =
