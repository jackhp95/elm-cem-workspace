module M3e.Family.NavMenu exposing
    ( NavMenuIs
    , NavMenuAttrs
    , NavMenuBuilder
    , NavMenuAttrCaps
...
navMenuChild :
    Element NavMenuContent admittedBy msg -> Element free freeAdmittedBy msg
navMenuChild =
    NavMenu_.child
...
itemOpen :
    Bool -> Attr { c | open : Supported } msg
itemOpen =
    Item_.open
...
itemOnOpening :
    msg -> Attr { c | onOpening : Supported } msg
itemOnOpening =
    Item_.onOpening
...
itemOnOpened :
    msg -> Attr { c | onOpened : Supported } msg
itemOnOpened =
    Item_.onOpened
...
itemOnClosing :
    msg -> Attr { c | onClosing : Supported } msg
itemOnClosing =
    Item_.onClosing
...
itemOnClosed :
    msg -> Attr { c | onClosed : Supported } msg
itemOnClosed =
    Item_.onClosed
...
itemBadge :
    Element ItemBadgeSlot admittedBy msg -> Element free freeAdmittedBy msg
itemBadge =
    Item_.badge
...
itemLabel :
    Element ItemLabelSlot admittedBy msg -> Element free freeAdmittedBy msg
itemLabel =
    Item_.label
...
itemSelectedIcon :
    Element ItemSelectedIconSlot admittedBy msg -> Element free freeAdmittedBy msg
itemSelectedIcon =
    Item_.selectedIcon
...
itemToggleIcon :
    Element ItemToggleIconSlot admittedBy msg -> Element free freeAdmittedBy msg
itemToggleIcon =
    Item_.toggleIcon
...
itemGroupLabel :
    Element ItemGroupLabelSlot admittedBy msg -> Element free freeAdmittedBy msg
itemGroupLabel =
    ItemGroup_.label
