module M3e.Family.SegmentedButton exposing
    ( SegmentedButtonIs
    , SegmentedButtonAttrs
    , SegmentedButtonBuilder
    , SegmentedButtonAttrCaps
    , SegmentedButtonSlotCaps
    , SegmentedButtonContent
    , SegmentedButtonChildAdmittedBy
    , SegmentIs
    , SegmentAttrs
    , SegmentBuilder
    , SegmentAttrCaps
...
segmentedButtonChild :
    Element SegmentedButtonContent admittedBy msg -> Element free freeAdmittedBy msg
segmentedButtonChild =
...
segmentIcon :
    Element SegmentIconSlot admittedBy msg -> Element free freeAdmittedBy msg
segmentIcon =
    Segment_.icon
...
segmentChild :
    Element SegmentContent admittedBy msg -> Element free freeAdmittedBy msg
segmentChild =
    Segment_.child
...
{-| See [`M3e.Component.ButtonGroup.size`](M3e.Component.ButtonGroup#size). -}
groupSize :
    Value GroupSize -> Attr { c | size : Supported } msg
groupSize =
    Group_.size
...
{-| See [`M3e.Component.ButtonGroup.variant`](M3e.Component.ButtonGroup#variant). -}
groupVariant :
    Value GroupVariant -> Attr { c | variant : Supported } msg
groupVariant =
    Group_.variant
...
groupChild :
    Element GroupContent admittedBy msg -> Element free freeAdmittedBy msg
groupChild =
    Group_.child
