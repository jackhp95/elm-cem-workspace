module M3e.Family.Menu exposing
    ( MenuIs
    , MenuAttrs
    , MenuBuilder
    , MenuAttrCaps
    ...
    , ItemContent
    , ItemIconSlot
    , ItemTrailingIconSlot
    , ItemChildAdmittedBy
    , ItemCheckboxIs
    , ItemCheckboxAttrs
    , ItemCheckboxBuilder
    , ItemCheckboxAttrCaps
    , ItemCheckboxSlotCaps
    , ItemCheckboxContent
    , ItemCheckboxIconSlot
    , ItemCheckboxTrailingIconSlot
    , ItemCheckboxChildAdmittedBy
    , ItemGroupIs
    , ItemGroupAttrs
    , ItemGroupBuilder
    , ItemGroupAttrCaps
    ...
    , ItemRadioContent
    , ItemRadioIconSlot
    , ItemRadioTrailingIconSlot
    , ItemRadioChildAdmittedBy
    , TriggerIs
    , TriggerAttrs
    , TriggerBuilder
    , TriggerAttrCaps
...
{-| See [`M3e.Component.Menu.positionX`](M3e.Component.Menu#positionX). -}
menuPositionX :
    Value MenuPositionX -> Attr { c | positionX : Supported } msg
menuPositionX =
    Menu_.positionX
...
{-| See [`M3e.Component.Menu.positionY`](M3e.Component.Menu#positionY). -}
menuPositionY :
    Value MenuPositionY -> Attr { c | positionY : Supported } msg
menuPositionY =
    Menu_.positionY
...
{-| See [`M3e.Component.Menu.variant`](M3e.Component.Menu#variant). -}
menuVariant :
    Value MenuVariant -> Attr { c | variant : Supported } msg
menuVariant =
    Menu_.variant
...
menuSubmenu :
    Bool -> Attr { c | submenu : Supported } msg
menuSubmenu =
    Menu_.submenu
...
menuOnToggle :
    (String -> msg) -> Attr { c | onToggle : Supported } msg
menuOnToggle =
    Menu_.onToggle
...
menuChild :
    Element MenuContent admittedBy msg -> Element free freeAdmittedBy msg
menuChild =
    Menu_.child
...
itemIcon :
    Element ItemIconSlot admittedBy msg -> Element free freeAdmittedBy msg
itemIcon =
    Item_.icon
...
itemTrailingIcon :
    Element ItemTrailingIconSlot admittedBy msg -> Element free freeAdmittedBy msg
itemTrailingIcon =
    Item_.trailingIcon
...
itemCheckboxChecked :
    Bool -> Attr { c | checked : Supported } msg
itemCheckboxChecked =
...
itemCheckboxIcon :
    Element ItemCheckboxIconSlot admittedBy msg -> Element free freeAdmittedBy msg
itemCheckboxIcon =
    ItemCheckbox_.icon
...
itemCheckboxTrailingIcon :
    Element ItemCheckboxTrailingIconSlot admittedBy msg -> Element free freeAdmittedBy msg
itemCheckboxTrailingIcon =
...
itemCheckboxChild :
    Element ItemCheckboxContent admittedBy msg -> Element free freeAdmittedBy msg
itemCheckboxChild =
    ItemCheckbox_.child
...
itemGroupChild :
    Element ItemGroupContent admittedBy msg -> Element free freeAdmittedBy msg
itemGroupChild =
    ItemGroup_.child
...
itemRadioIcon :
    Element ItemRadioIconSlot admittedBy msg -> Element free freeAdmittedBy msg
itemRadioIcon =
    ItemRadio_.icon
...
itemRadioTrailingIcon :
    Element ItemRadioTrailingIconSlot admittedBy msg -> Element free freeAdmittedBy msg
itemRadioTrailingIcon =
...
itemRadioChild :
    Element ItemRadioContent admittedBy msg -> Element free freeAdmittedBy msg
itemRadioChild =
    ItemRadio_.child
