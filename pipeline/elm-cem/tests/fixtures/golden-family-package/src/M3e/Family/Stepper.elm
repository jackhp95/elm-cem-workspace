module M3e.Family.Stepper exposing
    ( StepperIs
    , StepperAttrs
    , StepperBuilder
    , StepperAttrCaps
    ...
    , PreviousAttrCaps
    , PreviousSlotCaps
    , PreviousChildAdmittedBy
    , ResetIs
    , ResetAttrs
    , ResetBuilder
    , ResetAttrCaps
    , ResetSlotCaps
    , ResetChildAdmittedBy
    , stepper
    , stepperHeaderPosition
    , stepperLabelPosition
    , stepperOrientation
...
{-| See [`M3e.Component.Stepper.headerPosition`](M3e.Component.Stepper#headerPosition). -}
stepperHeaderPosition :
    Value StepperHeaderPosition -> Attr { c | headerPosition : Supported } msg
stepperHeaderPosition =
    Stepper_.headerPosition
...
{-| See [`M3e.Component.Stepper.labelPosition`](M3e.Component.Stepper#labelPosition). -}
stepperLabelPosition :
    Value StepperLabelPosition -> Attr { c | labelPosition : Supported } msg
stepperLabelPosition =
    Stepper_.labelPosition
...
{-| See [`M3e.Component.Stepper.orientation`](M3e.Component.Stepper#orientation). -}
stepperOrientation :
    Value StepperOrientation -> Attr { c | orientation : Supported } msg
stepperOrientation =
    Stepper_.orientation
...
stepperLinear :
    Bool -> Attr { c | linear : Supported } msg
stepperLinear =
    Stepper_.linear
...
stepperPanel :
    Element StepperPanelSlot admittedBy msg -> Element free freeAdmittedBy msg
stepperPanel =
    Stepper_.panel
...
stepperStep :
    Element StepperStepSlot admittedBy msg -> Element free freeAdmittedBy msg
stepperStep =
    Stepper_.step
...
stepCompleted :
    Bool -> Attr { c | completed : Supported } msg
stepCompleted =
    Step_.completed
...
stepEditable :
    Bool -> Attr { c | editable : Supported } msg
stepEditable =
    Step_.editable
...
stepInvalid :
    Bool -> Attr { c | invalid : Supported } msg
stepInvalid =
    Step_.invalid
...
stepOptional :
    Bool -> Attr { c | optional : Supported } msg
stepOptional =
    Step_.optional
...
stepDoneIcon :
    Element StepDoneIconSlot admittedBy msg -> Element free freeAdmittedBy msg
stepDoneIcon =
    Step_.doneIcon
...
stepEditIcon :
    Element StepEditIconSlot admittedBy msg -> Element free freeAdmittedBy msg
stepEditIcon =
    Step_.editIcon
...
stepError :
    Element StepErrorSlot admittedBy msg -> Element free freeAdmittedBy msg
stepError =
    Step_.error
...
stepErrorIcon :
    Element StepErrorIconSlot admittedBy msg -> Element free freeAdmittedBy msg
stepErrorIcon =
    Step_.errorIcon
...
stepHint :
    Element StepHintSlot admittedBy msg -> Element free freeAdmittedBy msg
stepHint =
    Step_.hint
...
stepIcon :
    Element StepIconSlot admittedBy msg -> Element free freeAdmittedBy msg
stepIcon =
    Step_.icon
...
stepChild :
    Element StepContent admittedBy msg -> Element free freeAdmittedBy msg
stepChild =
    Step_.child
