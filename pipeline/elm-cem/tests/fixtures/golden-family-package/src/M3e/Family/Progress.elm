module M3e.Family.Progress exposing
    ( CircularIs
    , CircularAttrs
    , CircularBuilder
    , CircularAttrCaps
    , CircularSlotCaps
    , CircularChildAdmittedBy
    , CircularVariant
    , LinearIs
    , LinearAttrs
    , LinearBuilder
...
{-| See [`M3e.Component.CircularProgressIndicator.variant`](M3e.Component.CircularProgressIndicator#variant). -}
circularVariant :
    Value CircularVariant -> Attr { c | variant : Supported } msg
circularVariant =
    Circular_.variant
...
circularMax :
    Float -> Attr { c | max : Supported } msg
circularMax =
    Circular_.max
...
circularValue :
    Float -> Attr { c | value : Supported } msg
circularValue =
    Circular_.value
...
{-| See [`M3e.Component.LinearProgressIndicator.mode`](M3e.Component.LinearProgressIndicator#mode). -}
linearMode :
    Value LinearMode -> Attr { c | mode : Supported } msg
linearMode =
    Linear_.mode
...
{-| See [`M3e.Component.LinearProgressIndicator.variant`](M3e.Component.LinearProgressIndicator#variant). -}
linearVariant :
    Value LinearVariant -> Attr { c | variant : Supported } msg
linearVariant =
    Linear_.variant
...
linearBufferValue :
    Float -> Attr { c | bufferValue : Supported } msg
linearBufferValue =
    Linear_.bufferValue
...
{-| See [`M3e.Component.LoadingIndicator.variant`](M3e.Component.LoadingIndicator#variant). -}
loadingVariant :
    Value LoadingVariant -> Attr { c | variant : Supported } msg
loadingVariant =
    Loading_.variant
