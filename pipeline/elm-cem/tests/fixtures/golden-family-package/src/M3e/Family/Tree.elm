module M3e.Family.Tree exposing
    ( TreeIs
    , TreeAttrs
    , TreeBuilder
    , TreeAttrCaps
...
treeCascade :
    Bool -> Attr { c | cascade : Supported } msg
treeCascade =
    Tree_.cascade
...
treeChild :
    Element TreeContent admittedBy msg -> Element free freeAdmittedBy msg
treeChild =
    Tree_.child
...
itemIndeterminate :
    Bool -> Attr { c | indeterminate : Supported } msg
itemIndeterminate =
    Item_.indeterminate
...
itemOpenToggleIcon :
    Element ItemOpenToggleIconSlot admittedBy msg -> Element free freeAdmittedBy msg
itemOpenToggleIcon =
