module M3e.Family.Timepicker exposing
    ( TimepickerIs
    , TimepickerAttrs
    , TimepickerBuilder
    , TimepickerAttrCaps
    , TimepickerSlotCaps
    , TimepickerChildAdmittedBy
    , TimepickerFormat
    , TimepickerMode
    ...
    , InputViewAttr
    , InputPeriodToggleIs
    , InputPeriodToggleAttrs
    , InputPeriodToggleBuilder
    , InputPeriodToggleAttrCaps
    , InputPeriodToggleSlotCaps
    , InputPeriodToggleChildAdmittedBy
...
{-| See [`M3e.Component.Timepicker.format`](M3e.Component.Timepicker#format). -}
timepickerFormat :
    Value TimepickerFormat -> Attr { c | format : Supported } msg
timepickerFormat =
    Timepicker_.format
...
{-| See [`M3e.Component.Timepicker.mode`](M3e.Component.Timepicker#mode). -}
timepickerMode :
    Value TimepickerMode -> Attr { c | mode : Supported } msg
timepickerMode =
    Timepicker_.mode
...
{-| See [`M3e.Component.Timepicker.orientation`](M3e.Component.Timepicker#orientation). -}
timepickerOrientation :
    Value TimepickerOrientation -> Attr { c | orientation : Supported } msg
timepickerOrientation =
    Timepicker_.orientation
...
{-| See [`M3e.Component.Timepicker.variant`](M3e.Component.Timepicker#variant). -}
timepickerVariant :
    Value TimepickerVariant -> Attr { c | variant : Supported } msg
timepickerVariant =
    Timepicker_.variant
...
timepickerConfirmLabel :
    String -> Attr { c | confirmLabel : Supported } msg
timepickerConfirmLabel =
...
timepickerDate :
    String -> Attr { c | date : Supported } msg
timepickerDate =
    Timepicker_.date
...
timepickerDialLabel :
    String -> Attr { c | dialLabel : Supported } msg
timepickerDialLabel =
...
timepickerDismissLabel :
    String -> Attr { c | dismissLabel : Supported } msg
timepickerDismissLabel =
...
timepickerFor :
    String -> Attr { c | for : Supported } msg
timepickerFor =
    Timepicker_.for
...
timepickerHideModeToggle :
    Bool -> Attr { c | hideModeToggle : Supported } msg
timepickerHideModeToggle =
...
timepickerHourLabel :
    String -> Attr { c | hourLabel : Supported } msg
timepickerHourLabel =
...
timepickerInputLabel :
    String -> Attr { c | inputLabel : Supported } msg
timepickerInputLabel =
...
timepickerMaxTime :
    String -> Attr { c | maxTime : Supported } msg
timepickerMaxTime =
    Timepicker_.maxTime
...
timepickerMinTime :
    String -> Attr { c | minTime : Supported } msg
timepickerMinTime =
    Timepicker_.minTime
...
timepickerMinuteLabel :
    String -> Attr { c | minuteLabel : Supported } msg
timepickerMinuteLabel =
...
timepickerModeToggleLabel :
    String -> Attr { c | modeToggleLabel : Supported } msg
timepickerModeToggleLabel =
...
timepickerPeriodToggleLabel :
    String -> Attr { c | periodToggleLabel : Supported } msg
timepickerPeriodToggleLabel =
...
timepickerSecondLabel :
    String -> Attr { c | secondLabel : Supported } msg
timepickerSecondLabel =
...
timepickerShowSeconds :
    Bool -> Attr { c | showSeconds : Supported } msg
timepickerShowSeconds =
...
timepickerOnBeforetoggle :
    msg -> Attr { c | onBeforetoggle : Supported } msg
timepickerOnBeforetoggle =
...
timepickerOnToggle :
    msg -> Attr { c | onToggle : Supported } msg
timepickerOnToggle =
...
{-| See [`M3e.Component.TimepickerDial.format`](M3e.Component.TimepickerDial#format). -}
dialFormat :
    Value DialFormat -> Attr { c | format : Supported } msg
dialFormat =
    Dial_.format
...
{-| See [`M3e.Component.TimepickerDial.period`](M3e.Component.TimepickerDial#period). -}
dialPeriod :
    Value DialPeriod -> Attr { c | period : Supported } msg
dialPeriod =
    Dial_.period
...
{-| See [`M3e.Component.TimepickerDial.viewAttr`](M3e.Component.TimepickerDial#viewAttr). -}
dialViewAttr :
    Value DialViewAttr -> Attr { c | viewAttr : Supported } msg
dialViewAttr =
    Dial_.viewAttr
...
dialHour :
    Float -> Attr { c | hour : Supported } msg
dialHour =
    Dial_.hour
...
dialMinute :
    Float -> Attr { c | minute : Supported } msg
dialMinute =
    Dial_.minute
...
dialSecond :
    Float -> Attr { c | second : Supported } msg
dialSecond =
    Dial_.second
...
dialOnViewChange :
    msg -> Attr { c | onViewChange : Supported } msg
dialOnViewChange =
    Dial_.onViewChange
...
{-| See [`M3e.Component.TimepickerInput.format`](M3e.Component.TimepickerInput#format). -}
inputFormat :
    Value InputFormat -> Attr { c | format : Supported } msg
inputFormat =
    Input_.format
...
{-| See [`M3e.Component.TimepickerInput.period`](M3e.Component.TimepickerInput#period). -}
inputPeriod :
    Value InputPeriod -> Attr { c | period : Supported } msg
inputPeriod =
    Input_.period
...
{-| See [`M3e.Component.TimepickerInput.viewAttr`](M3e.Component.TimepickerInput#viewAttr). -}
inputViewAttr :
    Value InputViewAttr -> Attr { c | viewAttr : Supported } msg
inputViewAttr =
    Input_.viewAttr
...
inputHideLabels :
    Bool -> Attr { c | hideLabels : Supported } msg
inputHideLabels =
    Input_.hideLabels
...
inputOrientation :
    String -> Attr { c | orientation : Supported } msg
inputOrientation =
    Input_.orientation
...
{-| See [`M3e.Component.TimepickerInputPeriodToggle.period`](M3e.Component.TimepickerInputPeriodToggle#period). -}
inputPeriodTogglePeriod :
    Value InputPeriodTogglePeriod -> Attr { c | period : Supported } msg
inputPeriodTogglePeriod =
    InputPeriodToggle_.period
