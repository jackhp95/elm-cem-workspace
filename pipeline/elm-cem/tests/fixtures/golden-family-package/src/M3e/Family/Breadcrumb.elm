module M3e.Family.Breadcrumb exposing
    ( BreadcrumbIs
    , BreadcrumbAttrs
    , BreadcrumbBuilder
    , BreadcrumbAttrCaps
...
breadcrumbWrap :
    Bool -> Attr { c | wrap : Supported } msg
breadcrumbWrap =
    Breadcrumb_.wrap
...
breadcrumbChild :
    Element BreadcrumbContent admittedBy msg -> Element free freeAdmittedBy msg
breadcrumbChild =
    Breadcrumb_.child
...
{-| See [`M3e.Component.BreadcrumbItem.current`](M3e.Component.BreadcrumbItem#current). -}
itemCurrent :
    Value ItemCurrent -> Attr { c | current : Supported } msg
itemCurrent =
    Item_.current
...
itemItemLabel :
    String -> Attr { c | itemLabel : Supported } msg
itemItemLabel =
    Item_.itemLabel
