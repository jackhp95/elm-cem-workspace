module M3e.Family.RichTooltip exposing
    ( RichTooltipIs
    , RichTooltipAttrs
    , RichTooltipBuilder
    , RichTooltipAttrCaps
    , RichTooltipSlotCaps
    , RichTooltipContent
    , RichTooltipSubheadSlot
    , RichTooltipChildAdmittedBy
    , RichTooltipPosition
...
{-| See [`M3e.Component.RichTooltip.position`](M3e.Component.RichTooltip#position). -}
richTooltipPosition :
    Value RichTooltipPosition -> Attr { c | position : Supported } msg
richTooltipPosition =
    RichTooltip_.position
...
{-| See [`M3e.Component.RichTooltip.touchGestures`](M3e.Component.RichTooltip#touchGestures). -}
richTooltipTouchGestures :
    Value RichTooltipTouchGestures -> Attr { c | touchGestures : Supported } msg
richTooltipTouchGestures =
    RichTooltip_.touchGestures
...
richTooltipHideDelay :
    Float -> Attr { c | hideDelay : Supported } msg
richTooltipHideDelay =
...
richTooltipShowDelay :
    Float -> Attr { c | showDelay : Supported } msg
richTooltipShowDelay =
...
richTooltipSubhead :
    Element RichTooltipSubheadSlot admittedBy msg -> Element free freeAdmittedBy msg
richTooltipSubhead =
...
richTooltipChild :
    Element RichTooltipContent admittedBy msg -> Element free freeAdmittedBy msg
richTooltipChild =
    RichTooltip_.child
...
actionDisableRestoreFocus :
    Bool -> Attr { c | disableRestoreFocus : Supported } msg
actionDisableRestoreFocus =
