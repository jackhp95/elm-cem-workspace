module M3e.Family.Accordion exposing
    ( AccordionIs
    , AccordionAttrs
    , AccordionBuilder
    , AccordionAttrCaps
...
accordionChild :
    Element AccordionContent admittedBy msg -> Element free freeAdmittedBy msg
accordionChild =
    Accordion_.child
...
{-| See [`M3e.Component.ExpansionPanel.HeaderSlot`](M3e.Component.ExpansionPanel#HeaderSlot). -}
...
{-| See [`M3e.Component.ExpansionPanel.toggleDirection`](M3e.Component.ExpansionPanel#toggleDirection). -}
panelToggleDirection :
    Value PanelToggleDirection -> Attr { c | toggleDirection : Supported } msg
panelToggleDirection =
    Panel_.toggleDirection
...
{-| See [`M3e.Component.ExpansionPanel.togglePosition`](M3e.Component.ExpansionPanel#togglePosition). -}
panelTogglePosition :
    Value PanelTogglePosition -> Attr { c | togglePosition : Supported } msg
panelTogglePosition =
    Panel_.togglePosition
...
panelHideToggle :
    Bool -> Attr { c | hideToggle : Supported } msg
panelHideToggle =
    Panel_.hideToggle
...
panelHeader :
    Element PanelHeaderSlot admittedBy msg -> Element free freeAdmittedBy msg
panelHeader =
    Panel_.header
...
panelToggleIcon :
    Element PanelToggleIconSlot admittedBy msg -> Element free freeAdmittedBy msg
panelToggleIcon =
    Panel_.toggleIcon
