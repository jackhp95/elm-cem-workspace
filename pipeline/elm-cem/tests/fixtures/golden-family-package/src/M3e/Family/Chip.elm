module M3e.Family.Chip exposing
    ...
    , FilterContent
    , FilterIconSlot
    , FilterTrailingIconSlot
    , FilterChildAdmittedBy
    , FilterVariant
    , InputIs
    , InputAttrs
    , InputBuilder
    ...
    , SuggestionContent
    , SuggestionIconSlot
    , SuggestionChildAdmittedBy
    , SuggestionActionCaps
    , SuggestionType
    , SuggestionVariant
    , SetIs
    , SetAttrs
...
{-| See [`M3e.Component.Chip.variant`](M3e.Component.Chip#variant). -}
chipVariant :
    Value ChipVariant -> Attr { c | variant : Supported } msg
chipVariant =
    Chip_.variant
...
chipValue :
    String -> Attr { c | value : Supported } msg
chipValue =
    Chip_.value
...
chipIcon :
    Element ChipIconSlot admittedBy msg -> Element free freeAdmittedBy msg
chipIcon =
    Chip_.icon
...
chipTrailingIcon :
    Element ChipTrailingIconSlot admittedBy msg -> Element free freeAdmittedBy msg
chipTrailingIcon =
    Chip_.trailingIcon
...
chipChild :
    Element ChipContent admittedBy msg -> Element free freeAdmittedBy msg
chipChild =
    Chip_.child
...
assistType_ :
    Value AssistType -> Attr { c | type_ : Supported } msg
assistType_ =
    Assist_.type_
...
{-| See [`M3e.Component.AssistChip.variant`](M3e.Component.AssistChip#variant). -}
assistVariant :
    Value AssistVariant -> Attr { c | variant : Supported } msg
assistVariant =
    Assist_.variant
...
assistDisabled :
    Bool -> Attr { c | disabled : Supported } msg
assistDisabled =
    Assist_.disabled
...
assistDisabledInteractive :
    Bool -> Attr { c | disabledInteractive : Supported } msg
assistDisabledInteractive =
...
assistDownload :
    String -> Attr { c | download : Supported } msg
assistDownload =
    Assist_.download
...
assistHref :
    String -> Attr { c | href : Supported } msg
assistHref =
    Assist_.href
...
assistName :
    String -> Attr { c | name : Supported } msg
assistName =
    Assist_.name
...
assistRel :
    String -> Attr { c | rel : Supported } msg
assistRel =
    Assist_.rel
...
assistTarget :
    String -> Attr { c | target : Supported } msg
assistTarget =
    Assist_.target
...
assistOnClick :
    msg -> Attr { c | onClick : Supported } msg
assistOnClick =
    Assist_.onClick
...
assistIcon :
    Element AssistIconSlot admittedBy msg -> Element free freeAdmittedBy msg
assistIcon =
    Assist_.icon
...
assistChild :
    Element AssistContent admittedBy msg -> Element free freeAdmittedBy msg
assistChild =
    Assist_.child
...
{-| See [`M3e.Component.FilterChip.variant`](M3e.Component.FilterChip#variant). -}
filterVariant :
    Value FilterVariant -> Attr { c | variant : Supported } msg
filterVariant =
    Filter_.variant
...
filterSelected :
    Bool -> Attr { c | selected : Supported } msg
filterSelected =
    Filter_.selected
...
filterOnBeforeinput :
    msg -> Attr { c | onBeforeinput : Supported } msg
filterOnBeforeinput =
...
filterOnInput :
    msg -> Attr { c | onInput : Supported } msg
filterOnInput =
    Filter_.onInput
...
filterOnChange :
    msg -> Attr { c | onChange : Supported } msg
filterOnChange =
    Filter_.onChange
...
filterIcon :
    Element FilterIconSlot admittedBy msg -> Element free freeAdmittedBy msg
filterIcon =
    Filter_.icon
...
filterTrailingIcon :
    Element FilterTrailingIconSlot admittedBy msg -> Element free freeAdmittedBy msg
filterTrailingIcon =
...
filterChild :
    Element FilterContent admittedBy msg -> Element free freeAdmittedBy msg
filterChild =
    Filter_.child
...
{-| See [`M3e.Component.InputChip.variant`](M3e.Component.InputChip#variant). -}
inputVariant :
    Value InputVariant -> Attr { c | variant : Supported } msg
inputVariant =
    Input_.variant
...
inputRemovable :
    Bool -> Attr { c | removable : Supported } msg
inputRemovable =
    Input_.removable
...
inputRemoveLabel :
    String -> Attr { c | removeLabel : Supported } msg
inputRemoveLabel =
    Input_.removeLabel
...
inputOnRemove :
    msg -> Attr { c | onRemove : Supported } msg
inputOnRemove =
    Input_.onRemove
...
inputAvatar :
    Element InputAvatarSlot admittedBy msg -> Element free freeAdmittedBy msg
inputAvatar =
    Input_.avatar
...
inputIcon :
    Element InputIconSlot admittedBy msg -> Element free freeAdmittedBy msg
inputIcon =
    Input_.icon
...
inputRemoveIcon :
    Element InputRemoveIconSlot admittedBy msg -> Element free freeAdmittedBy msg
inputRemoveIcon =
    Input_.removeIcon
...
inputChild :
    Element InputContent admittedBy msg -> Element free freeAdmittedBy msg
inputChild =
    Input_.child
...
suggestionType_ :
    Value SuggestionType -> Attr { c | type_ : Supported } msg
suggestionType_ =
    Suggestion_.type_
...
{-| See [`M3e.Component.SuggestionChip.variant`](M3e.Component.SuggestionChip#variant). -}
suggestionVariant :
    Value SuggestionVariant -> Attr { c | variant : Supported } msg
suggestionVariant =
    Suggestion_.variant
...
suggestionIcon :
    Element SuggestionIconSlot admittedBy msg -> Element free freeAdmittedBy msg
suggestionIcon =
    Suggestion_.icon
...
suggestionChild :
    Element SuggestionContent admittedBy msg -> Element free freeAdmittedBy msg
suggestionChild =
    Suggestion_.child
...
setVertical :
    Bool -> Attr { c | vertical : Supported } msg
setVertical =
    Set_.vertical
...
setChild :
    Element SetContent admittedBy msg -> Element free freeAdmittedBy msg
setChild =
    Set_.child
...
filterSetHideSelectionIndicator :
    Bool -> Attr { c | hideSelectionIndicator : Supported } msg
filterSetHideSelectionIndicator =
...
filterSetMulti :
    Bool -> Attr { c | multi : Supported } msg
filterSetMulti =
    FilterSet_.multi
...
filterSetChild :
    Element FilterSetContent admittedBy msg -> Element free freeAdmittedBy msg
filterSetChild =
    FilterSet_.child
...
{-| See [`M3e.Component.InputChipSet.maxChips`](M3e.Component.InputChipSet#maxChips). -}
inputSetMaxChips :
    Float -> Attr { c | maxChips : Supported } msg
inputSetMaxChips =
    InputSet_.maxChips
...
inputSetRequired :
    Bool -> Attr { c | required : Supported } msg
inputSetRequired =
    InputSet_.required
...
inputSetValidationmessages :
    String -> Attr { c | validationmessages : Supported } msg
inputSetValidationmessages =
...
inputSetInput :
    Element childAccepts admittedBy msg -> Element free freeAdmittedBy msg
inputSetInput =
    InputSet_.input
...
inputSetChild :
    Element InputSetContent admittedBy msg -> Element free freeAdmittedBy msg
inputSetChild =
    InputSet_.child
