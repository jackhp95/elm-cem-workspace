module Hz.Component.TextElement exposing (TextElementIs, TextElementAttrs, TextElementBuilder, TextElementAttrCaps, TextElementSlotCaps, TextElementContent, TextElementChildAdmittedBy, textElement, textElementChild)
