module Hz.Component.ErrorOnly exposing (ErrorOnlyIs, ErrorOnlyAttrs, ErrorOnlyBuilder, ErrorOnlyAttrCaps, ErrorOnlySlotCaps, ErrorOnlyChildAdmittedBy, errorOnly, errorOnlyOnHzError)
