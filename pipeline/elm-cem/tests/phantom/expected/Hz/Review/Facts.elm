...
facts =
    ...
    , { component = "textElement"
      , module_ = "Hz.Element.TextElement"
      , enums = []
      , requiredSlots = []
      , multiSlots = []
      , attrRewrites = []
