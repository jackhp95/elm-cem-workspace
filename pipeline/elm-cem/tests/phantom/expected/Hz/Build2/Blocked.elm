module Hz.Build2.Blocked exposing (Builder, AttrCaps, SlotCaps, Is, Content, ChildAdmittedBy, build, toElement, withClass, withId, withLabel, withSlot, withStyle, withChild)

{-| The **Blocked** family — COMPOSED builders (DAG-rework Task 3 dual-emit).

One module carrying every member's builder surface
(degenerate single-member family — flat, un-prefixed surface),
sourced through `Hz.Component2.Blocked` (the family façade) rather
...
import Hz.Component2.Blocked as Component
...
{-| -}
type alias Is s =
    Component.BlockedIs s


{-| -}
type alias Builder attrCaps slotCaps msg kind =
    Component.BlockedBuilder attrCaps slotCaps msg kind


{-| -}
type alias AttrCaps =
    Component.BlockedAttrCaps


{-| -}
type alias SlotCaps =
    Component.BlockedSlotCaps


{-| -}
type alias ChildAdmittedBy childAdm =
    Component.BlockedChildAdmittedBy childAdm
...
{-| -}
toElement : Builder attrCaps slotCaps msg kind -> Element (Component.BlockedIs kind) admittedBy msg
toElement =
    B.toElement
