module Hz.Component2.Global exposing (GlobalIs, GlobalAttrs, GlobalBuilder, GlobalAttrCaps, GlobalSlotCaps, GlobalContent, GlobalChildAdmittedBy, global, globalChild)
