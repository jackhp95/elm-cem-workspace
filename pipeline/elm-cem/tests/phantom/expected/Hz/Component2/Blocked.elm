module Hz.Component2.Blocked exposing (BlockedIs, BlockedAttrs, BlockedBuilder, BlockedAttrCaps, BlockedSlotCaps, BlockedContent, BlockedChildAdmittedBy, blocked, blockedLabel, blockedChild)
