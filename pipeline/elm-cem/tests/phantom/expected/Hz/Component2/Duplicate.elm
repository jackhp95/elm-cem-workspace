module Hz.Component2.Duplicate exposing (DuplicateIs, DuplicateAttrs, DuplicateBuilder, DuplicateAttrCaps, DuplicateSlotCaps, DuplicateContent, DuplicateChildAdmittedBy, duplicate, duplicateValue, duplicateDefaultValue, duplicateChild)
