module Br.Component2.Barren exposing (BarrenIs, BarrenAttrs, BarrenBuilder, BarrenAttrCaps, BarrenSlotCaps, BarrenContent, BarrenChildAdmittedBy, barren, barrenCount, barrenLabel, barrenChild)
