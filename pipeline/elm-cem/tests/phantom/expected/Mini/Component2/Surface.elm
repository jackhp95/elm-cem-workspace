module Mini.Component2.Surface exposing (SurfaceIs, SurfaceAttrs, SurfaceBuilder, SurfaceAttrCaps, SurfaceSlotCaps, SurfaceChildAdmittedBy, surface, surfaceGrid, surfaceGridAsInts, surfaceChild)
