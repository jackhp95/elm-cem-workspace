module Mini.Component2.Chip exposing (ChipIs, ChipAttrs, ChipBuilder, ChipAttrCaps, ChipSlotCaps, ChipContent, ChipChildAdmittedBy, ChipSize, chip, chipSize, chipDisabled, chipChild)
