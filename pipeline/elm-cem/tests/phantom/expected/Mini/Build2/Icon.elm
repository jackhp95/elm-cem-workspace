module Mini.Build2.Icon exposing (Builder, AttrCaps, SlotCaps, Is, Content, ChildAdmittedBy, build, toElement, withClass, withDir, withId, withInert, withSlot, withStyle, withTabindex, withChild)

{-| The **Icon** family — COMPOSED builders (DAG-rework Task 3 dual-emit).

One module carrying every member's builder surface
(degenerate single-member family — flat, un-prefixed surface),
sourced through `Mini.Component2.Icon` (the family façade) rather
...
@docs Builder, AttrCaps, SlotCaps, Is, Content, ChildAdmittedBy, build, toElement, withClass, withDir, withId, withInert, withSlot, withStyle, withTabindex, withChild
...
import Mini.Component2.Icon as Component
