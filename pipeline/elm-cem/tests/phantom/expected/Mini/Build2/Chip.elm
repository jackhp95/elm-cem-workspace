module Mini.Build2.Chip exposing (Builder, AttrCaps, SlotCaps, Is, Content, ChildAdmittedBy, build, toElement, withClass, withDir, withDisabled, withId, withInert, withSize, withSlot, withStyle, withTabindex, withChild)

{-| The **Chip** family — COMPOSED builders (DAG-rework Task 3 dual-emit).

One module carrying every member's builder surface
(degenerate single-member family — flat, un-prefixed surface),
sourced through `Mini.Component2.Chip` (the family façade) rather
...
import Mini.Component2.Chip as Component
