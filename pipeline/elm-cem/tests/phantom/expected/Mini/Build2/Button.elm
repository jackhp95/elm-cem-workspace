module Mini.Build2.Button exposing (Builder, AttrCaps, SlotCaps, Is, Content, IconSlot, ChildAdmittedBy, build, toElement, withClass, withDir, withDisabled, withId, withInert, withOnClick, withSlot, withStyle, withTabindex, withVariant, withWeight, icon, withIcon, withChild)

{-| The **Button** family — COMPOSED builders (DAG-rework Task 3 dual-emit).

One module carrying every member's builder surface
(degenerate single-member family — flat, un-prefixed surface),
sourced through `Mini.Component2.Button` (the family façade) rather
...
import Mini.Component2.Button as Component
