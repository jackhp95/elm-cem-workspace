module Mini.Build2.Tabs exposing (Builder, AttrCaps, SlotCaps, Is, Content, ChildAdmittedBy, build, toElement, withClass, withDir, withId, withInert, withSlot, withStyle, withTabindex, withChild)

{-| The **Tabs** family — COMPOSED builders (DAG-rework Task 3 dual-emit).

One module carrying every member's builder surface
(degenerate single-member family — flat, un-prefixed surface),
sourced through `Mini.Component2.Tabs` (the family façade) rather
...
import Mini.Component2.Tabs as Component
...
{-| -}
toElement : Builder attrCaps slotCaps msg kind -> Element (Component.TabsIs kind) admittedBy msg
toElement =
    B.toElement
