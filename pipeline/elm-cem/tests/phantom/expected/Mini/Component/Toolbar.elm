module Mini.Component.Toolbar exposing (ToolbarIs, ToolbarAttrs, ToolbarBuilder, ToolbarAttrCaps, ToolbarSlotCaps, ToolbarChildAdmittedBy, toolbar, toolbarChild)
