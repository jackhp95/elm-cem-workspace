module Or.Component.Widget exposing (WidgetIs, WidgetAttrs, WidgetBuilder, WidgetAttrCaps, WidgetSlotCaps, WidgetContent, WidgetChildAdmittedBy, widget, widgetLabel, widgetChild)
